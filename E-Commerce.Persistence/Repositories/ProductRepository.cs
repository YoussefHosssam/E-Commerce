...
internal class ProductRepository : GenericRepository<Product>, IProductRepository
{
    ...
    {
        _productDbSet = ecommerceContext.Set<Product>();
    }

    public async Task<PagedResult<Product>> GetPagedProducts(PageRequest pageRequest, CancellationToken ctn)
    {
        return await _productDbSet.AsNoTracking().ToPagedResultAsync(pageRequest, ctn);
    }
    ...
    {
        IQueryable<Product> query = _productDbSet;
