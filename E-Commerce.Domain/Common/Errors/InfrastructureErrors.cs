...
public static class InfrastructureErrors
{
    ...
    public static readonly Error PaymentGatewayFail = new(ErrorCodes.Infrastructure.PaymentGatewayFail, "The payment gateway is temporarily unavailable." , ErrorType.Failure);
}
